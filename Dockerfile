FROM --platform=$TARGETPLATFORM dunglas/frankenphp@sha256:462c2d0eb8dd4fae16b7396f9873e0d52aab5c62d1abd0f1303bcf05041eed4e AS base
USER root
...
COPY --from=composer/composer:2-bin@sha256:989ad47cea06cb9365afda43d7431a238c6abf913d631b9cf043eb0d43f783ae /composer /usr/bin/composer
USER www-data
