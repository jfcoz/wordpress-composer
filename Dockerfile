FROM --platform=$TARGETPLATFORM dunglas/frankenphp@sha256:f45d76172f0211d6036161056e655970e265a58d93a8a0c2c5a6d4049f6d0202 AS base
USER root
...
COPY --from=composer/composer:2-bin@sha256:6a8b987cd68b8c38863bf05cba6a5776ddd2f6753a20b83e12a1d6ae4827d4a5 /composer /usr/bin/composer
USER www-data
