FROM --platform=$TARGETPLATFORM dunglas/frankenphp@sha256:d1bcdfa135d09066fcaeb4f395ad7d333c6c3f9f39a0d63e92ac95e7aace4de6 AS base
USER root
...
COPY --from=composer/composer:2-bin@sha256:9f83907ae037ada989775f462a19932cdd388fefcbf3b697780363bba1767f94 /composer /usr/bin/composer
USER www-data
