FROM --platform=$TARGETPLATFORM dunglas/frankenphp@sha256:412b326f1c46ef558dbc40718211cb25c9965cd4467cc9139799d232cdea4a25 AS base
USER root
...
COPY --from=composer/composer:2-bin@sha256:b075cc912babe511f14e8336a8854eb29be15751a547fddeb2be248d87b45cde /composer /usr/bin/composer
USER www-data
