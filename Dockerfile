FROM --platform=$TARGETPLATFORM dunglas/frankenphp@sha256:29c3b6550a68f48a79a6fac0fa78a20520dd2167fd6a5c726405fa8fe5609564 AS base
USER root
...
COPY --from=composer/composer:2-bin@sha256:edce3c39c93452b17920181bc13e75fc06883dfd4c835eafa182877772880af3 /composer /usr/bin/composer
USER www-data
